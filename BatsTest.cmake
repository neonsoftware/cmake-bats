...
function(bats_discover_tests TARGET)
  ...
  elseif(_DISCOVERY_MODE STREQUAL "PRE_TEST")
    ...
    message(">>>> At this pont ${ctest_include_file} and ")

    if(GENERATOR_IS_MULTI_CONFIG)
      foreach(_config ${CMAKE_CONFIGURATION_TYPES} - ${ctest_file_base} - ${ctest_file_base})
